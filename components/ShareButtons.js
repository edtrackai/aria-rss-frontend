...
export default function ShareButtons({ article }) {
  ...
  const shareUrl = `https://ai-reviewed.com/article/${article.slug}`;
  const shareText = `${article.title} - Real UK prices & honest review by ARIA`;
  ...
  return (
    <div className="flex items-center gap-3 py-4 mb-6 border-b">
